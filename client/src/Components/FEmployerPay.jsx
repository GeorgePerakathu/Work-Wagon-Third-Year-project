...
const TABLE_HEAD = ["Project Name","Freelancer Name", "Tracking Id", "Project status", "Payment Status"];

// Sample static data for demonstration
const sampleData = [
  {Project_Name : "Mind Therapy",
    Freelancer_Name: "John Doe",
    Tracking_Id: "ABC123",
    Project_status: "accepted",
    Payment_Status: "success",
  },
  {Project_Name : " App Deck",
        ...
        <table className="w-full min-w-max table-auto text-left bg-blue-800">
          ...
          <tbody>
            {(addData || sampleData).map(
              (
                { Project_Name, Freelancer_Name, Tracking_Id, Project_status, Payment_Status },
                index
              ) => (
                <tr key={index}>
                    <td className="p-4">
